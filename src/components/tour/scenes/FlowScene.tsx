  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0">
        <div className={cn(
          "absolute top-1/3 left-1/3 w-[40%] aspect-square rounded-full blur-[100px] transition-all duration-1000",
          timeline.isActive('header') ? "bg-indigo-500/8 opacity-100" : "opacity-0"
        )} />
      </div>
