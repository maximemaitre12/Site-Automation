      ...
      <div className="max-w-6xl mx-auto px-6">
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-6 mb-20">
          {benefits.map((benefit, i) => (
            <div key={i} className="text-center p-6 rounded-2xl bg-background border border-border">
              <div className="text-xl md:text-2xl font-bold text-primary mb-2">{benefit.title}</div>
        ...
        <div className="max-w-3xl mx-auto text-center">
          ...
          <div>
            ...
            <p className="text-sm text-muted-foreground">Request a personalized demo today</p>
          </div>
        </div>
      </div>
    </section>
