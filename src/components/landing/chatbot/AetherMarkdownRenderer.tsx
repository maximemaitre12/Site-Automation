...
function ActionButton({ text, onSend }: { text: string; onSend: (msg: string) => void }) {
  return (
    ...
    >
      ...
      <span className="flex-1 text-[12px] font-medium text-[#0EA5E9] group-hover:text-[#38BDF8] transition-colors">
        {text}
      </span>
      <svg width="14" height="14" viewBox="0 0 24 24" fill="none" className="text-[#0EA5E9]/40 group-hover:text-[#0EA5E9]/70 transition-colors shrink-0">
...
function ActionGroup({
  ...
  return (
    <div className={compact ? "my-2" : "my-4"}>
      {title && (
        <div className="mb-3">
          <div className="text-[9.5px] font-bold tracking-[0.16em] uppercase" style={{ color: "#0EA5E9" }}>
            {title}
          </div>
          {details.length > 0 && (
  ...
  return {
    ...
    h2: ({ children }) => (
      <div className="flex items-center gap-2.5 mt-6 mb-3 first:mt-0">
        ...
        />
        <span className="text-[9.5px] font-bold tracking-[0.16em] uppercase" style={{ color: "#0EA5E9" }}>
          {children}
        </span>
      </div>
    ),
      ...
      return (
        ...
        >
          <div
            ...
            style={{ background: "linear-gradient(180deg, #0EA5E9 0%, #38BDF8 60%, #7DD3FC 100%)" }}
          />
    ...
    a: ({ href, children }) => (
      <a
        ...
        className="text-[#0EA5E9] underline decoration-[#0EA5E9]/20 underline-offset-2 hover:decoration-[#0EA5E9]/50 transition-colors font-medium"
      >
        {children}
      </a>
    ),
