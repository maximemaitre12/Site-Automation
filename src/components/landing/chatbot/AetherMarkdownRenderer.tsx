  ...
  return (
    ...
    >
      <span
        ...
        style={{ background: "linear-gradient(135deg, #1E4D8C, #1E4D8C)", color: "white" }}
      >
        →
      </span>
      <span className="flex-1 text-[12px] font-medium text-[#1E4D8C] group-hover:text-[#1E4D8C] transition-colors">
        {text}
      </span>
      <svg width="14" height="14" viewBox="0 0 24 24" fill="none" className="text-[#1E4D8C]/40 group-hover:text-[#1E4D8C]/70 transition-colors shrink-0">
...
function ActionGroup({
  ...
  return (
    <div className={compact ? "my-2" : "my-4"}>
      {title && (
        <div className="mb-3">
          <div className="text-[9.5px] font-bold tracking-[0.16em] uppercase" style={{ color: "#1E4D8C" }}>
            {title}
          </div>
          {details.length > 0 && (
  ...
  return {
    ...
    h2: ({ children }) => (
      <div className="flex items-center gap-2.5 mt-6 mb-3 first:mt-0">
        <div
          ...
          style={{ background: "linear-gradient(180deg, #1E4D8C 0%, #1E4D8C 100%)" }}
        />
        <span className="text-[9.5px] font-bold tracking-[0.16em] uppercase" style={{ color: "#1E4D8C" }}>
          {children}
        </span>
      </div>
    ),
      ...
      return (
        <li className="flex items-start gap-2.5 text-[12.5px] leading-[1.7]">
          <span
            ...
            style={{ background: "linear-gradient(135deg, #1E4D8C, #1E4D8C)" }}
          />
      ...
      return (
        ...
        >
          <div
            ...
            style={{ background: "linear-gradient(180deg, #1E4D8C 0%, #1E4D8C 60%, #5BA3C9 100%)" }}
          />
    ...
    a: ({ href, children }) => (
      <a
        ...
        className="text-[#1E4D8C] underline decoration-[#1E4D8C]/20 underline-offset-2 hover:decoration-[#1E4D8C]/50 transition-colors font-medium"
      >
        {children}
      </a>
    ),
