        ...
        >
          ...
          >
            ...
            <svg width="20" height="20" viewBox="0 0 24 24" fill="none" className="text-white relative z-10">
              ...
              <circle cx="8" cy="11" r="1.2" fill="#1E4D8C"/>
              <circle cx="12" cy="11" r="1.2" fill="#1E4D8C"/>
              <circle cx="16" cy="11" r="1.2" fill="#1E4D8C"/>
            </svg>
          </div>
        </button>
      )}
                ...
                <div className="pt-12 pb-4">
                  ...
                  <div className="mb-10">
                    <div className="inline-flex items-center gap-1.5 px-2.5 py-1 rounded-full bg-[#0F172A]/5 mb-4">
                      <div className="w-1.5 h-1.5 rounded-full bg-[#1E4D8C]" />
              ...
              <div className={`px-4 py-3 ${isFullscreen ? "max-w-3xl mx-auto" : ""}`}>
                ...
                >
                  ...
                  <button
                    ...
                    style={{
                      background: isLoading || !input.trim() ? "#E2E8F0" : "linear-gradient(135deg, #1E4D8C 0%, #1E4D8C 100%)",
