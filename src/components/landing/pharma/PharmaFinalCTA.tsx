...
export function PharmaFinalCTA() {
  return (
    <section
      ...
      style={{
        background: "linear-gradient(160deg, #0891B2 0%, #22D3EE 50%, #67E8F9 100%)",
      }}
    >
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        <div className="absolute -top-24 -right-24 w-[450px] h-[450px] rounded-full" style={{ background: "rgba(255,255,255,0.06)" }} />
        <div className="absolute -bottom-36 -left-36 w-[550px] h-[550px] rounded-full" style={{ background: "rgba(255,255,255,0.04)" }} />
      </div>
      <div className="relative max-w-[1400px] mx-auto px-6 lg:px-12 z-10">
        <p className="text-[11px] font-semibold tracking-[0.3em] uppercase mb-8" style={{ color: "rgba(255,255,255,0.5)" }}>Prochaine étape</p>
        <h2 className="font-heading text-[36px] md:text-5xl lg:text-[56px] font-bold leading-[1.08] text-white mb-6">
          Prêt à transformer
          <br />
          vos opérations ?
        </h2>
        <p className="text-[15px] md:text-base max-w-[480px] mb-14 leading-[1.8]" style={{ color: "rgba(255,255,255,0.7)" }}>
