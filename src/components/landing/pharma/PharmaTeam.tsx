export function PharmaTeam() {
  return (
    <section id="team" className="py-36 md:py-44 bg-white">
      <div className="max-w-[1400px] mx-auto px-6 lg:px-12">
        <div className="grid lg:grid-cols-2 gap-20 lg:gap-32">
          ...
          <div className="space-y-12">
            <div>
              <p className="text-sm mb-2" style={{ color: "#94A3B8" }}>Fondateur</p>
              <h3 className="font-heading text-2xl font-bold mb-3" style={{ color: "#0F172A" }}>
                Nicolas Parisi
              </h3>
            ...
            <div>
              <p className="text-sm mb-2" style={{ color: "#94A3B8" }}>Co-fondateur</p>
              <h3 className="font-heading text-2xl font-bold mb-3" style={{ color: "#0F172A" }}>
