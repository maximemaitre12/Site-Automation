...
export function PharmaTeam() {
  return (
    <section id="team" className="py-32 md:py-40" style={{ background: "#D6EEF5" }}>
      <div className="max-w-[1400px] mx-auto px-6 lg:px-12">
        ...
        <div className="grid lg:grid-cols-2 gap-16 lg:gap-28">
          <div>
            ...
            <p className="text-[15px] md:text-base leading-[1.8]" style={{ color: "#334155" }}>
          ...
          <div className="space-y-14">
            <div>
              ...
              <p className="text-[15px] leading-[1.8]" style={{ color: "#334155" }}>
