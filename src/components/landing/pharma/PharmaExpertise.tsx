...
export function PharmaExpertise() {
  return (
    <section id="expertise" className="py-32 md:py-40" style={{ background: "#F7F8FA" }}>
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-x-14 gap-y-14">
          {areas.map((a) => (
            <div key={a.title} className="group cursor-default">
              <h3
                className="font-heading text-[12px] font-bold tracking-[0.18em] mb-4 transition-colors group-hover:opacity-60"
                style={{ color: "#0F172A" }}
              >
                {a.title}
              </h3>
